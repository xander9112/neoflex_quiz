    ...
    return Expanded(
      child: LayoutBuilder(
        builder: (context, constraints) {
          return Stack(
            children: [
              Positioned.fill(child: Container(decoration: bgDecoration)),
              AnimatedBuilder(
                ...
                builder: (context, _) {
                  return Align(
                    alignment: Alignment.center.add(
                      Alignment(
                        0,
                        Curves.bounceIn.transform(_controller.value) * 5,
                      ),
                    ),
              ...
              IgnorePointer(
                child: Align(
                  ...
                  child: LottieAnimation(width: constraints.maxWidth * 0.6),
                ),
              ),
            ],
          ).animate().fadeIn(
